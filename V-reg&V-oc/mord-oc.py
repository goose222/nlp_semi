...
# 载入数据
train = 'V-data-vector/2018-Valence-oc-En-train_new-vector.json'
test = 'V-data-vector/2018-Valence-oc-En-test-gold_new-vector.json'
dev = 'V-data-vector/2018-Valence-oc-En-dev_new-vector.json'
...
clf=mord.OrdinalRidge(alpha=70.0,max_iter=1000) #alpha:70 r: 75.76
